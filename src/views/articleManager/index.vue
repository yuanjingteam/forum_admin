  ...
  <div class="container">
    ...
    <a-card class="general-card" title="查询表格">
        ...
        <a-col :flex="1">
          ...
          >
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item field="article_tags" label="内容体裁">
                  <a-select
                    v-model="formModel.article_tags"
      ...
      >
        ...
        <template #article_tags="{ record }">
          <a-space>
            <a-avatar
              v-if="record.article_tags === 'img'"
              :size="16"
              shape="square"
            >
              <img
            ...
            <a-avatar
              v-else-if="record.article_tags === 'horizontalVideo'"
              :size="16"
              shape="square"
            >
              <img
            ...
            {{
              record.article_tags === 'img'
                ? '图文'
                : record.article_tags === 'horizontalVideo'
                  ? '横版短视频'
                  : '竖版短视频'
            }}
          </a-space>
